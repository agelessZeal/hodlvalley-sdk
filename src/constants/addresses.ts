...
export const FACTORY_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.RINKEBY]: '0xCF286c7922acE42e2AbDd209a73A97A0249FF186',
...
export const ROUTER_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.RINKEBY]: '0xd55520789Bd6D23B0616Fb58B2AC5ffB3B93e616',
...
export const SUSHI_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.RINKEBY]: '0xd0CB6B6fDBe3462dFBCAC11f440EA0D21484D0f5',
...
export const MASTERCHEF_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.RINKEBY]: '0x7B72167C19080143402B22C3D6E4362133FC3441',
...
export const BAR_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.RINKEBY]: '0x3483e39b3f090B530C22b0CC3aF0C18e5962eC80',
...
export const MAKER_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.RINKEBY]: '0xbFE51bCA53D357E8A8cedF1fC65B87B43c703dDe',
